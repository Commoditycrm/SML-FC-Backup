({
    ...
    handleRecordCreated: function(component, event, helper) {
        ...
        const filterName = event.getParam('filterName');

        component.set('v.recordId', recordId);
        component.set('v.filterName', filterName);

        var selectComponent = component.find("option");
        ...
        var options = selectComponent.get("v.options");
        options.push(newOption);
        selectComponent.set("v.options", options);

        selectComponent.set("v.value", recordId);

        var picklistChangeEvent = component.get('c.onPicklistChange');
        $A.enqueueAction(picklistChangeEvent);
    }
