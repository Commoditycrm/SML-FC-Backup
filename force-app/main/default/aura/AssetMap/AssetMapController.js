    ...
    jsLoaded: function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            if (response.getState() === "SUCCESS") {
                ...
                //this.getuserLatLng(component, event, helper);
                ...
                legend.onAdd = function () {
                    ...
                    var plang = component.get("v.Language");
                    if(plang == 'es'){
                        var astType = "Activo" ;
                    var singleRackTransitText = "Soltera " + astType + " en tránsito por encima del límite deshonesto";
                    if(acc != null){
                        astType =typeof acc.Map_PickList__c === "undefined"  ? "Activo" : acc.Map_PickList__c;
                        singleRackTransitText =typeof acc.Rogue_Asset_Day_Limit__c === "undefined" ? "Soltera " + astType + " en tránsito por encima del límite deshonesto" : 
                    ...
                    <div id="legendContent" class="legend-content">
                        ...
                        <div class="slds-m-bottom_xx-small"> <p><span class="legend-icon single-rack"></span> Soltera ${astType}</p></div>
                        <div class="slds-m-bottom_xx-small"> <p><span class="legend-icon single-rack-transit"></span> ${singleRackTransitText}</p></div>
                        <div class="slds-m-bottom_xx-small"> <p><span class="legend-icon many-racks"></span> Muchas ${astType}s (haz zoom para ver más detalles)</p></div>
                        <div class="slds-m-bottom_xx-small"> <p><span class="legend-icon known-location"></span> Ubicación conocida</p></div>
                        </div>
    ...
    getuserLatLng: function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                var allValues = response.getReturnValue();
                 component.set("v.Language", allValues.LanguageLocaleKey);
                component.set("v.userCountry",allValues.Country);
